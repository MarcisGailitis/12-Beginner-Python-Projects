...
class TicTacToe():
    def __init__(self):
        # we will use a single list ro represent 3x3 grid
    ...
    def winner(self, square, letter):
        # winner if 3 in a horizontally, diagonally or vertically
        # let's check the row
        row_ind = square // 3
        ...
        # as these are the only moves possible to win diagonal
        if square % 2 == 0:
